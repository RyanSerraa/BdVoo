...
companhiaAerea["Companhia.Aerea"] = companhiaAerea["Companhia.Aerea"].str.replace(
    r"\d", "", regex=True
)
# Obter os valores únicos da coluna "Voos"
...
cidades_destino_nacionais = cidades_destino_nacionais[
    [
        "Cidade.Origem",
        "Estado.Origem",
        "Codigo.Tipo.Linha",
...
cidades_nacionais = cidades_nacionais[
    [
        "Cidade.Origem",
        "Cidade.Destino",
        "Estado.Origem",
...
cidades_internacionais = cidades_internacionais[
    [
        "Cidade.Origem",
        "Cidade.Destino",
        "Estado.Origem",
